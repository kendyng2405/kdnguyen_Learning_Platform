// ============================================================
//  config.js — LearnFlow Configuration
//  ⚠️  Điền thông tin Firebase và Gemini API key của bạn vào đây
// ============================================================
...
export const APP_CONFIG = {
  ...
  defaultTheme: "light", // "light" hoặc "dark"
  adminEmails: [],       // Thêm email admin vào đây, ví dụ: ["admin@example.com"]
};
