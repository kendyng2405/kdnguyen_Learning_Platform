...
export class ChatbotController {
  ...
  async _callGemini(userMessage) {
    ...
    const lang     = window.__i18n.current;
    const userName = profile?.displayName || "bạn";

    const systemContext = lang === "vi"
      ? `Bạn là LearnBot, trợ lý AI của nền tảng học tập LearnFlow. 
      ...
      : `You are LearnBot, the AI assistant for the LearnFlow learning platform. 
